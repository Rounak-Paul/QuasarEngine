...
static const char *g_editor_css =
    ...
    ".inspector-axis-x { color: #cc4444; font-size: 12px; min-width: 10px; }"
    ".inspector-axis-y { color: #44cc44; font-size: 12px; min-width: 10px; }"
    ".inspector-axis-z { color: #4477cc; font-size: 12px; min-width: 10px; }"
    ".inspector-axis-w { color: #cc44cc; font-size: 12px; min-width: 10px; }"
