...
const char *g_editor_css =
    ...
    ".status-project-icon { color: " ED_COL_PRIMARY "; }"
    ".status-scene-icon   { color: " ED_COL_TEXT_MEDIUM "; }"
    ".status-render-icon  { color: " ED_COL_TEXT_MEDIUM "; }"

    ".status-fps-good { color: " ED_COL_SUCCESS "; }"
    ".status-fps-warn { color: " ED_COL_WARNING "; }"
    ".status-fps-bad  { color: " ED_COL_DANGER "; }"

    ".status-log-empty { color: " ED_COL_TEXT_DIM "; }"
    ".status-log-debug { color: " ED_COL_TEXT_DIM "; }"
    ".status-log-trace { color: " ED_COL_TEXT_MUTED "; }"
    ".status-log-info  { color: " ED_COL_SUCCESS "; }"
    ".status-log-warn  { color: " ED_COL_WARNING "; }"
    ".status-log-error { color: " ED_COL_DANGER "; }"
    ".status-log-fatal { color: " ED_COL_DANGER "; }"
    ".status-log-value { color: " ED_COL_TEXT_BRIGHT "; }"
    ...
    ".pm-list-item-selected { background: " ED_COL_SURFACE "; }"
    ...
    ".pm-list-accent-active   { background: " ED_COL_SUCCESS "; }"
    ".pm-list-accent-loading  { background: " ED_COL_WARNING "; }"
    ".pm-list-accent-disabled { background: transparent; }"
    ...
    ".pm-list-item-name-active { color: " ED_COL_TEXT_BRIGHT "; }"
    ...
    ".pm-detail-desc-none { color: " ED_COL_TEXT_DIM "; }"
    ...
    "  border-top-color: " ED_COL_SEPARATOR ";"
    "}"
    ...
    ".pm-action-enable  { background: " ED_COL_SUCCESS "; color: " ED_COL_VOID "; }"
    ".pm-action-disable { background: " ED_COL_SURFACE "; color: " ED_COL_TEXT_MUTED "; }"
    ".pm-action-reload  { background: transparent; color: " ED_COL_PRIMARY "; }"
