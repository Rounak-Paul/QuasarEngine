...
namespace Quasar
{
Dockspace::Dockspace() : GuiWindow("Dockspace") {
...
void Dockspace::render()
{
    ...
    ImGuiWindowFlags window_flags = ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoDocking | ImGuiWindowFlags_NoDecoration;
    if (opt_fullscreen)
    {
    ...
    ImGui::Begin(window_name.c_str(), &p_open, window_flags);
    if (!opt_padding)
        ImGui::PopStyleVar();
    if (opt_fullscreen)
        ImGui::PopStyleVar(2);
