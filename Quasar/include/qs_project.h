...
QS_API Qs_Project *qs_project_create(const Qs_ProjectDesc *desc);
...
QS_API Qs_Project *qs_project_open(const char *project_dir);

/// Persists the project file (asset_db, etc.) to disk.
QS_API bool qs_project_save(const Qs_Project *project);

/// Returns the project display name.
QS_API const char *qs_project_name(const Qs_Project *project);

/// Returns the project root directory path.
QS_API const char *qs_project_path(const Qs_Project *project);

/// Destroys the project handle (does NOT delete project files).
QS_API void qs_project_destroy(Qs_Project *project);
...
QS_API const char *qs_project_startup_scene(const Qs_Project *project);

/// Set the startup scene.  Path may be absolute or project-relative.
/// Caller must qs_project_save() to persist.
QS_API bool qs_project_set_startup_scene(Qs_Project *project, const char *path);

/// Number of scenes registered in the project.
QS_API uint32_t qs_project_scene_count(const Qs_Project *project);

/// Project-relative path of the i-th scene, or NULL if out of range.
QS_API const char *qs_project_scene_path(const Qs_Project *project, uint32_t index);

/// Register a scene path in the project.  Duplicates are ignored.
/// Caller must qs_project_save() to persist.
QS_API bool qs_project_register_scene(Qs_Project *project, const char *path);

/// Remove a scene from the project.  Caller must qs_project_save().
/// Also clears startup_scene if it matches.
QS_API bool qs_project_unregister_scene(Qs_Project *project, const char *path);
...
QS_API uint32_t qs_project_prototype_count(const Qs_Project *project);

/// Project-relative path of the i-th prototype, or NULL if out of range.
QS_API const char *qs_project_prototype_path(const Qs_Project *project, uint32_t index);
...
QS_API bool qs_project_register_prototype(Qs_Project *project, const char *path);

/// Remove a prototype from the asset DB.  Caller must qs_project_save().
QS_API bool qs_project_unregister_prototype(Qs_Project *project, const char *path);
...
QS_API uint32_t qs_project_check_assets(const Qs_Project *project);
...
QS_API void qs_project_make_relative(const Qs_Project *project,
                              const char *path,
                              char *out, size_t out_size);

/// Resolve a project-relative path to an absolute path.
/// If `path` is already absolute, it is copied as-is.
QS_API void qs_project_resolve(const Qs_Project *project,
                        const char *path,
                        char *out, size_t out_size);
...
QS_API void qs_project_scan_assets(Qs_Project *project);

/// Number of .qstex files found by the last qs_project_scan_assets() call.
QS_API uint32_t    qs_project_texture_count  (const Qs_Project *project);
/// Project-relative path to the i-th .qstex file, or NULL if out of range.
QS_API const char *qs_project_texture_path   (const Qs_Project *project, uint32_t index);

/// Number of .qsmat files found by the last qs_project_scan_assets() call.
QS_API uint32_t    qs_project_material_count (const Qs_Project *project);
/// Project-relative path to the i-th .qsmat file, or NULL if out of range.
QS_API const char *qs_project_material_path  (const Qs_Project *project, uint32_t index);

/// Number of .qsmesh files found by the last qs_project_scan_assets() call.
QS_API uint32_t    qs_project_mesh_count     (const Qs_Project *project);
/// Project-relative path to the i-th .qsmesh file, or NULL if out of range.
QS_API const char *qs_project_mesh_path      (const Qs_Project *project, uint32_t index);
