...
QS_API Qs_JobCounter* qs_job_counter_create(Qs_JobSystem* system);

/// Frees a counter. Must only be called after all jobs using it have completed.
QS_API void qs_job_counter_destroy(Qs_JobSystem* system, Qs_JobCounter* counter);
...
/// is not needed.
QS_API void qs_job_dispatch(Qs_JobSystem* system, const Qs_JobDesc* job,
                     Qs_JobCounter* counter);

/// Submits a batch of jobs sharing the same counter.
QS_API void qs_job_dispatch_batch(Qs_JobSystem* system, const Qs_JobDesc* jobs,
...
QS_API void qs_job_wait(Qs_JobSystem* system, Qs_JobCounter* counter);

/// Returns the number of worker threads.
QS_API uint32_t qs_job_system_thread_count(const Qs_JobSystem* system);
